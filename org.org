...
** TODO [#A] prioritize the tasks 
   ...
   :PROPERTIES:
   :LAST_REPEAT: [2017-04-17 Mon 14:49]
   :END:
...
*** TODO [#B] adding content to the website 

*** TODO [#A] adding login/signup to the project 
    DEADLINE: <2017-04-16 Sun>
...
*** TODO [#B] daily English reading
    ...
    :PROPERTIES:
    :STYLE:    habit
    :LAST_REPEAT: [2017-04-17 Mon 14:50]
    :END:
- advanced English 
- novel, newspaper, etc. 
...
[[file:invest.org]]
*** DONE [#B] history analysis, keep note 
    CLOSED: [2017-04-17 Mon 17:07]

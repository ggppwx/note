...
* ORG MODE process work flow 
** TODO [#A] prioritize the tasks 
   SCHEDULED: <2017-04-02 Sun +3d>
   - State "DONE"       from "TODO"       [2017-03-30 Thu 18:01]
   :PROPERTIES:
   :LAST_REPEAT: [2017-03-30 Thu 18:01]
   :END:
...
*** TODO [#B] fix the broken org page

** COMP smart button count 
   CLOSED: [2017-03-10 Fri 18:09] DEADLINE: <2017-03-05 Sun>
   - State "PROGRESS"   from "READY"      [2017-03-01 Wed 10:37]
*** features 
- keep the project simple !!! 
- huge button  in one page 
- statistic in another page 
- calendar chart to track 
- smart button page
- user login support 
- in database 
- alert of undo
...
- plunker
- [X] can add/remove
- [X] count the activities 
- [X] display all statistic charts 
- [X] push to add
- [ ] undo
- [ ] restrain ? 

*** DONE smart button enhancement
    CLOSED: [2017-03-19 Sun 00:00]
- https://jsfiddle.net/dbzx1rzg/1/#&togetherjs=VOPMzHpE3q
- [X] daily timeline
- [X] go to prod
 
*** DONE smart button enhancement
    CLOSED: [2017-03-26 Sun 22:56] DEADLINE: <2017-03-26 Sun>
- [X] responsive 
https://plnkr.co/edit/VrYYTLV4xfpGSOA5IfjA
...
** emacs toolkit 						      :emacs:
*** DONE make the pomodora run in agenda mode
    CLOSED: [2017-02-17 Fri 18:38]

*** DONE more details in pomodora
    CLOSED: [2017-02-27 Mon 17:29]
- [ ] current time 
...
*** TODO daily English reading
    ...
    :PROPERTIES:
    :STYLE:    habit
    :LAST_REPEAT: [2017-03-30 Thu 10:42]
    :END:
- advanced English 
- novel, newspaper, etc. 
...
** TODO [#A] reflection, writing journal
   SCHEDULED: <2017-03-30 Thu .+3d/5d>
   ...
   :PROPERTIES:
   :LAST_REPEAT: [2017-03-27 Mon 00:35]
   :STYLE:    habit
   :END:
...
** DONE a org web service running on personal server
   CLOSED: [2017-03-30 Thu 18:09]
- [ ] always sync org with github
- [ ] webdav ? 


** DONE file/media server
   CLOSED: [2017-03-30 Thu 18:08]
- [X] samba server  
- [ ] video 
...
*** DONE do research on your own investing history 
    CLOSED: [2017-02-14 Tue 00:25] DEADLINE: <2017-01-08 Sun>
- gain & lose 
- bucket of stocks 

*** TODO history analysis, keep note 
    SCHEDULED: <2017-04-01 Sat +1w>
    - State "DONE"       from "TODO"       [2017-03-23 Thu 11:09]
